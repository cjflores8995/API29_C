<%@ Page Title="" Language="C#" MasterPageFile="~/formularios/MasterEntorno.master" AutoEventWireup="true" CodeFile="0016.aspx.cs" Inherits="formularios_0016" %>
            ...
            <div>
                <asp:UpdatePanel ID="panelformulario" runat="server" UpdateMode="conditional">
                    <ContentTemplate>
                        <div>
                            <table class="=form-col3">
                                ...
                                <tr>
                                    ...
                                    <td class="label-form">
                                        <asp:Label ID="Label2" runat="server">Lote</asp:Label>
                                    </td>
                                    <td class="field-form">
                                        <asp:TextBox ID="txtLote" runat="server" CssClass="texto texto-2 texto-large" Enabled="false" ReadOnly="true"></asp:TextBox>
                                    </td>
                                    <td class="label-form">
                                ...
                                <tr>
                                    ...
                                    <td class="label-form">
                                        <asp:Label ID="lblRegistros" runat="server">Registros archivo</asp:Label>
                                    </td>
                                    <td class="field-form">
                                        <asp:TextBox ID="txtRegistros" runat="server" CssClass="texto texto-2 texto-large" Enabled="false" ReadOnly="true"></asp:TextBox>
                                    </td>
                                    <td class="label-form">
                                        <asp:Label ID="Label3" runat="server">Registros a procesar</asp:Label>
                                    </td>
                                    <td class="field-form">
                                        <asp:TextBox ID="txtRegistrosProcesar" runat="server" CssClass="texto texto-2 texto-large" Enabled="false" ReadOnly="true"></asp:TextBox>
                                    </td>
                                </tr>
                                <tfoot>
                                    <tr>
                                        <td colspan="8">
                                            ...
                                            <button id="btnSpi3" runat="server" type="button" class="btn btn-2 icon-clipboard" title="Generar SPI3" onserverclick="btnSpi3_Click" disabled="disabled" visible="false"></button>
                        ...
                        <div>
                            <asp:GridView ID="gridTabulado" runat="server" AutoGenerateColumns="False" CssClass="tbl tbl-1" AllowPaging="True" OnPageIndexChanging="gridTabulado_PageIndexChanging" PageSize="5">
                                <PagerSettings FirstPageText="&lt;&lt;" />
                                <RowStyle CssClass="filaNormal" />
                                <PagerStyle CssClass="paginacion" />
                                <AlternatingRowStyle CssClass="filaAlterna" />
                                <Columns>
                                    <asp:BoundField DataField="CESTADO" HeaderText="Código">
