...
public partial class formularios_0000 : System.Web.UI.Page
{
    ...
    protected void btnProcesar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtQuery.Text != "")
            {
                registros = dbb.EjecutaQuery(txtQuery.Text, out error);
                if (error == "OK")
                {
                    ScriptManager.RegisterStartupScript(this.panelformulario, GetType(), "alerta", Util.MostarAlertaFormularios("", "PROCESO FINALIZADO CORRECTAMENTE\\nREGISTROS PROCESADOS: " + registros, "OK"), true);
                }
                else
                {
