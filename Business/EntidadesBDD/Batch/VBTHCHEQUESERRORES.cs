...
namespace Business
{
    public class VBTHCHEQUESERRORES
    {
        #region variables
        ...
        public List<VBTHCHEQUESERRORES> Listar(DateTime fproceso, Int32 cproceso)
        {
            AccesoDatosOracle ado = new AccesoDatosOracle();
            OracleCommand comando = new OracleCommand();
            StringBuilder query = new StringBuilder();
            List<VBTHCHEQUESERRORES> ltObj = null;
            ...
            try
            {
                ...
                query.Append(" VALOR ");
                query.Append(" FROM VBTHCHEQUESERRORES ");
                ...
                if (reader.HasRows)
                {
                    ltObj = new List<VBTHCHEQUESERRORES>();
                    while (reader.Read())
                    {
                        ltObj.Add(new VBTHCHEQUESERRORES
                        {
